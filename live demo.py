...
carImg = pygame.image.load('lol.jpg')
...
def live ():
	...
	sModelFile = "20190511-2107-chalearn249-oflow-i3d-entire-best.h5"
	h, w = 224, 224
...
def main():
    ...
    while True:
        ...
        button("live",150,600,100,50,gray,gray,live )
        button("Quit",550,600,100,50,gray,gray,close)
        #button("camera",550,450,100,50,gray,gray,open camera)
